	...
	public class TiledMapObjectsWindow : EditorWindow
	{
		...
		public static void Init(NanoXMLNode objectLayerNode)
		{
			...
			string name = objectLayerNode.GetAttribute("name") != null ?
				...
				"ObjectLayer";
            window.titleContent = new GUIContent(name, name); ;
		...
		void OnGUI()
		{
            ...
            _mainFoldout = EditorGUILayout.Foldout(_mainFoldout, new GUIContent(this.titleContent.text, TiledMapComponentEditor.objectIcon));
