...
namespace X_UniTMX
{
	...
	public class TiledMapComponent : MonoBehaviour
	{
		...
		void LoadMap()
		{
			//tiledMap = new Map(MapTMX, MapTMXPath, gameObject, materialDefaultFile, DefaultSortingOrder);
            
            this.transform.localScale = this.transform.localScale * tiledMap.TileWidth/100.0f;
